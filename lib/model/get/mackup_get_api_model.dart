...
List<MackupModel> mackupModelFromJson(String str) => List<MackupModel>.from(
    json.decode(str).map((x) => MackupModel.fromJson(x)));

String mackupModelToJson(List<MackupModel> data) =>
...
class MackupModel {
  ...
  factory MackupModel.fromJson(Map<String, dynamic> json) => MackupModel(
        id: json["id"],
        brand: json["brand"],
        name: json["name"],
        price: json["price"],
